{<img src="https://travis-ci.org/rubiety/validates_lengths_from_database.svg?branch=master" alt="Build Status" />}[https://travis-ci.org/rubiety/validates_lengths_from_database]
{<img src="https://api.codeclimate.com/v1/badges/db62821be2ed655656aa/maintainability" />}[https://codeclimate.com/github/rubiety/validates_lengths_from_database/maintainability]
