...
This gem introspects your table schema for maximum lengths on string fields and automatically adds length validations to the model.

== In Progress

NOTE: This gem is not quite ready for use.  It will be released as a gem to rubygems.org once stable.
